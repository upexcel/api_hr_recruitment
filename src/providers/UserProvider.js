...
const create = (model, validate, body, validationResult) => new Promise((resolve, reject) => {
...
const login = (model, body) => {
	const password = crypto.createHash("sha256").update(body.password).digest("base64");
	delete body.confirm_password;
