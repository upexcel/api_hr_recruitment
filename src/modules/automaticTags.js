                    ...
                    .then((data) => {
                        if (data) {
                            _.forEach(data, (val, key) => {
                                if ((subject.match(new RegExp(val.title, 'gi'))) || ((tag.to && tag.from) && new Date(email_date).getTime() < new Date(val.to).getTime() && new Date(email_date).getTime() > new Date(val.from).getTime()) || ((vall.email) && email.match(new RegExp(val.email, 'gi')))) {
